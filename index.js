...
function addMarkerToArr(location, label, eBirdData) {
  ...
  const infoWindowContent = `
      <h3>${eBirdData[label - 1].comName} <a href="https://www.allaboutbirds.org/search/?q=${eBirdData[label - 1].comName}" target="_blank">species account</a><h3>
      <p>Location: ${eBirdData[label - 1].locName} <a target="_blank" href="https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(destination)}" >directions</a></p>
